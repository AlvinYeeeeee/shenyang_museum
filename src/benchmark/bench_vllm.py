...
"locust -f src/benchmark/bench_vllm.py --headless --users 10 --spawn-rate 1 -H http://localhost:8000"
...
context2 = """
沈阳地处辽河、浑河中下游，北、东部为山地，西、南部为两河冲积平原。自古以来就是适于人类居住的理想家园。7000多年前，新乐人在此翻开了沈阳文化史的第一页。随后，这里成为了周边诸文化的交汇中心后，这里成为了周边诸文化的交汇中心。在公元前300年左右，沈阳正式纳入中原王朝周朝的诸侯国——燕国版图。经过秦汉两代的经营，沈阳开启了城郭相望的盛世画卷。辽、金、元等北方  史的发展。明朝时期，沈阳建立了中
...
class QuickstartUser(HttpUser):
    ...
    @task
    def query_vllm(self):
        out = self.client.post("/v1/completions", json={
            "model": "Qwen/Qwen2.5-3B",
